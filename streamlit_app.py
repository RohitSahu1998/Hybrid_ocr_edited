            ...
            try:
                ...
                if not matched_data:
                    ...
                    with col1:
                        ...
                        # Provide Download Button for Highlighted Image
                        with open(highlight_image_path, "rb") as file:
                            st.download_button(
                                label="✅ Download Highlighted Image (.jpg)",
                                data=file,
                                file_name=f"highlighted_{uploaded_file.name}.jpg",
                                mime="image/jpeg",
